...
const addBookmarkAPI = async (product_id: number) => {
  return sendAuthenticatedRequest("my-account/wishlist/add-to-wishlist.php", {
    product_id: product_id,
  });
};
const removeBookmarkAPI = async (product_id: number) => {
  return sendAuthenticatedRequest(
    "my-account/wishlist/remove-from-wishlist.php",
    {
      product_id: product_id,
...
const getUserWallet = async (currency: string) => {
  return sendAuthenticatedRequest(
    "my-account/wallet/wallet-info.php",
    { currency: currency }
  );
};
const chargeUserWallet = async (couponCode: string) => {
  return sendAuthenticatedRequest(
    "my-account/wallet/charge-wallet.php",
    { code: couponCode }
  );
};
const couponInfo = async (couponCode: string) => {
  return sendAuthenticatedRequest(
    "cart/get-coupon-info.php",
